...
def init_browser():
    ...
    executable_path = {'path': r'C:\Users\rejan\Downloads\chromedriver_win32\chromedriver.exe'}
    browser = Browser('chrome', executable_path = r'C:\Users\rejan\Downloads\chromedriver_win32\chromedriver.exe', headless=False)
    return browser
